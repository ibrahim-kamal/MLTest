...
namespace VoiceMLTest
{
    ...
    {
        /// <summary>
        /// model input class for EmotionClassification.
        /// </summary>
        ...
        private static string MLNetModelPath = Path.GetFullPath("emotionClassification.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("col26");
            if (labelColumn == null)
            {
                throw new Exception("col26 column not found. Make sure the name searched for matches the name in the schema.");
            }
